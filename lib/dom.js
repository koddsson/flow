...
declare interface SVGAnimatedString {
  baseVal: string;
  animVal: string; //readonly
};

declare interface SVGURIReference {
  href: SVGAnimatedString; //readonly
}

declare interface SVGStringList {
    umberOfItems: number; //readonly
...
declare interface SVGAElement extends SVGElement, SVGURIReference, SVGTests, SVGLangSpace, SVGExternalResourcesRequired, SVGStylable, SVGTransformable {
...
declare interface SVGViewElement extends SVGElement, SVGExternalResourcesRequired, SVGFitToViewBox, SVGZoomAndPan {
